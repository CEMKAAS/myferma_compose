...
fun Finance(scope: CoroutineScope, drawerState: DrawerState) {
    Scaffold(
        topBar = {
            TopAppBar(title = "Мои Финансы", scope = scope, drawerState = drawerState)
        }
    ) { innerPadding ->
...
fun FinanceApp(modifier: Modifier) {
    ...
    Column(modifier = modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Row(
            ...
            Text(text = "Общая сумма", fontSize = 20.sp, modifier = Modifier.fillMaxWidth(0.42f))
            Text(
                text = "150 000,00",
                fontSize = 20.sp,
        ...
        Row(
            ...
            Text(text = "Расходы", fontSize = 20.sp, modifier = Modifier.fillMaxWidth(0.42f))
            Text(
                text = "150 000,00",
                fontSize = 20.sp,
                modifier = Modifier.fillMaxWidth(0.5f),
